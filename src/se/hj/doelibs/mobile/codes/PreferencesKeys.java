package se.hj.doelibs.mobile.codes;

/**
 * class which contains the names and keys of preferences
 *
 * @author Christoph
 */
public final class PreferencesKeys {
    ...
    public static final String KEY_USER_IS_ADMIN = "loggedInUserIsAdmin";
